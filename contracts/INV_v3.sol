...
contract InvestContract is TokenPullable, Pullable {
    ...
    uint public quorum;
    address commissionContractAddress;
    ...
    public {
        ...
        investor = _investor;
        quorum = icoContract.quorum();
        commissionContractAddress = icoContract.commissionContractAddress();

        commissionAmount = amountToPay-etherAmount;
    ...
    function() payable public notStarted only(investor) {
        ...
        /* icoContract.juryOnlineWallet().transfer(commissionAmount); */
        /* icoContract.commissionContractAddress().transfer(amountToPay-etherAmount); */
        icoContract.commissionContractAddress().transfer(commissionAmount);
